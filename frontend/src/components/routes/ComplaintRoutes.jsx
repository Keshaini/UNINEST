...
const ComplaintRoutes = ({
  ...
  return (
    <Routes>
      <Route path="/" element={<Navigate to="/complaints/student" replace />} />
      ...
      <Route path="/complaints/student" element={studentPageElement} />
      <Route path="/complaints/student/tickets" element={studentTicketsPageElement} />
      <Route path="/complaints/support" element={supportPageElement} />
      <Route path="*" element={<Navigate to="/complaints/student" replace />} />
    </Routes>
  );
};
