...
function Complaints() {
    ...
    const fetchComplaints = async () => {
        try {
            ...
            toast.error('Failed to retrieve complaint history.');
            setComplaints([]);
        } finally {
            setLoading(false);
        }
    ...
    const submitForm = async (e) => {
        ...
        if (!title || !description) {
            toast.warning('All fields are mandatory for incident documentation.');
            return;
        }
        ...
        try {
            ...
            toast.error('Failed to broadcast complaint. Verify network integrity.');
        } finally {
            setSubmitting(false);
        }
    };
