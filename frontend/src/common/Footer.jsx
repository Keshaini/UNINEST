...
function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-6 px-6 md:px-20 mt-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 border-b border-gray-700 pb-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="/invoice" className="hover:text-indigo-400 transition">Invoices</a></li>
            <li><a href="/payments" className="hover:text-indigo-400 transition">Payments</a></li>
            <li><a href="/payment-history" className="hover:text-indigo-400 transition">Payment History</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#" className="hover:text-indigo-400 transition">User Guide</a></li>
